...
`yigitbasalma/wdash-elastic-dashboard:3.1.6`, and that tag is published, for
...
```bash
docker pull yigitbasalma/wdash-elastic-dashboard:3.1.6
docker tag  yigitbasalma/wdash-elastic-dashboard:3.1.6 \
            <registry>/wdash-elastic-dashboard:3.1.6
docker push <registry>/wdash-elastic-dashboard:3.1.6
cd kubernetes && kustomize edit set image \
    yigitbasalma/wdash-elastic-dashboard=<registry>/wdash-elastic-dashboard:3.1.6
```
...
Browser journeys need the browser image, `yigitbasalma/wdash-browser:3.1.6` —
557MB against the server's 79MB on amd64, and published for the same two
architectures:

```bash
docker pull yigitbasalma/wdash-browser:3.1.6
