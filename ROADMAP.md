...
* **The browser is a deployment question.** It is a separate image —
  `--target browser`, measured at 557MB in the registry against the
  server's 79MB, a seventh of it. Anybody running a probe for uptime checks does not
  pull it. Where no browser agent is assigned, a journey reports as unknown
