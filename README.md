...
docker pull yigitbasalma/wdash-elastic-dashboard:3.1.4   # server, 79MB
docker pull yigitbasalma/wdash-browser:3.1.4             # + Chromium, 557MB
...
docker run -d yigitbasalma/wdash-browser:3.1.4 \
