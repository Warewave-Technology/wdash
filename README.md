...
docker pull yigitbasalma/wdash-elastic-dashboard:3.1.0   # server, 77MB
docker pull yigitbasalma/wdash-browser:3.1.0             # + Chromium, 555MB
...
docker run -d yigitbasalma/wdash-browser:3.1.0 \
